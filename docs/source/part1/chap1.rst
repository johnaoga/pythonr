...
1. **Anaconda** (recommandé) : Distribution complète incluant Python et de nombreuses bibliothèques scientifiques
   ...
   * Téléchargement : `Anaconda Distribution <https://www.anaconda.com/products/distribution>`_
...
2. **Jupyter Notebooks** : Environnement interactif pour le développement et la présentation
   ...
   * Installation : `Jupyter Installation Guide <https://jupyter.org/install>`_
...
2. **RStudio** : Environnement de développement intégré pour R
   ...
   * Téléchargement : `RStudio Download <https://www.rstudio.com/products/rstudio/download/>`_
...
* **Statistiques de programmation** : `Stack Overflow Survey <https://insights.stackoverflow.com/survey>`_
* **Science des données** : `Python vs R for Data Science <https://www.datacamp.com/blog/python-vs-r-for-data-science-whats-the-difference>`_
* **Comparaison détaillée** : `Python vs R Comparison <https://s3.amazonaws.com/assets.datacamp.com/email/other/Python+vs+R.pdf>`_
