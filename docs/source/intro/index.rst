...
Les sources de ce site web sont open-source et sur `GitHub <https://github.com/johnaoga/pythonr>`_.
N'hésitez pas à faire des pull requests si vous voyez des erreurs ou choses à corriger.
